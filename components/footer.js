            ...
            <Container>
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                        <h4 className="text-3xl text-green-200 font-semibold uppercase">
                            Michelle Smit
                        </h4>
                        <h5 className="text-lg text-white mt-0 mb-6">
                            ...
                            <div className="w-full lg:w-6/12 px-4 ml-auto">
                                ...
                                <ul className="list-unstyled">
                                    <li>
                                        <a
                                            href="#about"
                                            className="text-gray-300 hover:text-gray-900 font-semibold block pb-2 text-sm">
                                            About
                                        </a>
                                    </li>
                                    <li>
