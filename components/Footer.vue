    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap">
        <div class="w-full lg:w-2/12 px-4">
          <img class="object cover" style="width:100%;" src="../assets/img/logo_block.svg"/>
        </div>
        <div class="w-full lg:w-6/12 px-4">
          ...
          <p class="text-gray-200">HPCSA registered counselling psychologist based in Cape Town and specializing in addiction therapy. Due to the nature of online therapy is available for consultations globally.</p>
          <div class="mt-2">
          ...
          <div class="flex flex-wrap items-top mb-6">
            <div class="w-full lg:w-6/12 px-4 ml-auto">
              ...
              <ul class="list-unstyled">
                <li>
                  <a class="text-gray-600 hover:text-gray-900 font-semibold block pb-2 text-sm"
                    href="#about">About</a>
                </li>
                <li>
                  <a class="text-gray-600 hover:text-gray-900 font-semibold block pb-2 text-sm"
