        ...
        <nav className="bg-white">
                    ...
                    <div className="flex">
                        ...
                        <Link href="/">
                            <a className="flex-shrink-0 flex items-center">
                                ...
                                <div className="flex flex-col w-full ml-2 sm:ml-4 justify-center">
                                    <div className="w-full uppercase font-bold text-sm sm:text-xl lg:text-2xl leading-6">
                                        Michelle Smit
                                    </div>
                        ...
                        <div className="hidden md:ml-6 md:flex">
                            ...
                            <Link href="/therapy-services">
                                <a className="ml-8 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-green-300 focus:outline-none focus:text-gray-700 focus:border-green-300 transition duration-150 ease-in-out">
                                    Therapy Services
                                </a>
                            </Link>
                            <Link href="/therapy-services">
            ...
            <div className="hidden md:hidden">
                <div className="pt-2 pb-3">
                    <Link href="/">
                        <a className="block pl-3 pr-4 py-2 border-l-4 border-green-500 text-base font-medium text-green-700 bg-green-50 focus:outline-none focus:text-green-800 focus:bg-green-100 focus:border-green-700 transition duration-150 ease-in-out sm:pl-5 sm:pr-6">
                            Dashboard
                        </a>
                    </Link>
                    <Link href="/">
                        <a className="mt-1 block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out sm:pl-5 sm:pr-6">
                            Team
                        </a>
                    </Link>
                    <Link href="/">
