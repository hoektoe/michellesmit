                    ...
                    <div className="rounded-md shadow">
                      <Link href={blok.link_secondary_href.cached_url}>
                        <a
                          ...
                          className="flex items-center justify-center w-full px-8 py-3 text-base font-medium text-white border border-transparent rounded-md bg-brand-600 hover:bg-brand-500 md:py-4 md:text-lg md:px-10"
                        >
                          {blok.link_secondary_text}
                        </a>
                      </Link>
