...
export function Stat({
  ...
  return (
    <div className={clsx('rounded-xl bg-mist-950/2.5 p-6', className)} {...props}>
    ...
    <section className={clsx('py-16', className)} {...props}>
      <Container>
        <div className="relative flex flex-col gap-10 sm:gap-16">
          <hr className="absolute inset-x-0 -top-16 border-t border-mist-950/10" />
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <Subheading>{heading}</Subheading>
            <div className="flex max-w-xl flex-col gap-4 text-base/7 text-mist-700">
              {description}
            </div>
          </div>
